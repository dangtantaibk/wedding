...
import ogimage from "~/images/ogimage.jpeg";
import GalleryPhotos from "~/components/GalleryPhotos";

export const meta: V2_MetaFunction = () => {
  return [
    {
      title: " Tiệc cưới - Tấn Tài & Phương Thảo",
    },
    {
      description:
    ...
    { "og:title": "Tiệc cưới - Tấn Tài & Phương Thảo" },
    {
...
export default function Index() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="mb-5" style={{ marginBottom: 250}}>
          <h5
            className="text-center font-head font-bold text-3xl mb-1 text-[#EFEFEF]"
      ...
      <div className="py-24 bg-background text-gray-700 relative text-center font-sans">
        © {thisYear} by <span className="font-semibold">Tài</span>
      </div>
