...
const EVENT_DATE = "2023-09-23T11:00:00.000Z";
  ...
  return (
    <div className="w-full px-1 md:px-4">
      <div className="text-3xl font-head font-bold text-center mb-10 pt-10 text-gray-700 px-2">
        <h4 className="mb-1">Đếm ngược</h4>
        <h4>Tới ngày hôn nhân của chúng tôi</h4>
      </div>

      <div className="flex justify-center pb-20">
        <NumberCard number={countdown.days} label="Ngày" />
        <NumberCard number={countdown.hours} label="Giờ" />
        <NumberCard number={countdown.minutes} label="Phút" />
        <NumberCard number={countdown.seconds} label="Giây" />
      </div>
    </div>
  );
});
